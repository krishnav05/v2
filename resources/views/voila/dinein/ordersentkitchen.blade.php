  ...
  <body class="order-sent-kitchen">
    ...
    <div class="row mt-3">
      <div class="col-sm-6 m-auto sent-to-kitchen text-center p-3">
        <div class="row">
          <div class="col-sm-6">
          <a href="itemmenu"> <img src="{{theme_url('dine_in_asset/img/ic-kitchen-back.svg')}}"> </a>
        </div>
        <div class="col-sm-6">
          <a href="./"> <img src="{{theme_url('dine_in_asset/img/ic-start-page.svg')}}"> </a>
        </div>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript" src="{{ theme_url('dine_in_asset/js/lottie.js') }}"></script>
    <script type="text/javascript" src="{{ theme_url('dine_in_asset/js/data.js') }}"></script>
